...
// Determine writable upload directory (use tmp on serverless like Vercel)
...
try {
  ...
  // Ignore if not writable in serverless read-only FS; diskStorage will fail without tmp
}
